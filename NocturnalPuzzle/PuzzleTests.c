// PuzzleTests.c : Contains unit and functional tests for NocturnalPuzzle.c

#include "NocturnalPuzzle.h"
#include "PuzzleTests.h"

int test_rotate_puzzle(void) {
	char test_puzzle[20][20] = {
	...
	rotate_puzzle(test_puzzle);
	for (int i = 0; i < 20; i++) {
		for (int j = 0; j < 10; j++) {
			if ('b' != test_puzzle[i][j]) {
				return 1;
			}
		}
	}
...
int test_find_word(void) {
	...
	char test_puzzle[20][20] = {
				...
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','b','c','d','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','b','c','d','e','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				...
				{'a','a','a','a','a','a','a','a','a','a','a','a','d','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'},
				{'a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a','a'}
	};
	find_word(word, 5, test_puzzle, coords);
	if ((coords[0] == 9) && (coords[1] == 8)) {
		return 0;
	}
	else return 1;
}
int test_read_puzzles(void) {
	const char* filename = "C:\\Users\\graha\\source\\repos\\NocturnalPuzzle\\NocturnalPuzzle\\puzzle.txt";
	char expected1[20][20] = {
		...
		{'e', 'j', 'e', 'n', 'm', 'f', 'g', 'u', 'l', 'm', 'j', 'f', 's', 'd', 'u', 't', 'x', 'q', 'j', 'c'},
	...
	char expected2[20][20] = {
		{'i', 'w', 'j', 'm', 'j', 'w', 'v', 'v', 't', 'x', 'm', 'p', 'x', 'b', 's', 'j', 'k', 'i', 'f', 'r'},
		{'q', 'p', 'k', 'l', 'j', 'x', 'a', 'o', 'd', 'b', 'd', 'v', 's', 'y', 'k', 't', 'l', 'd', 'w', 'n'},
		{'g', 'y', 'b', 'x', 'j', 'p', 'd', 'q', 'v', 'p', 'm', 'j', 'j', 'b', 'p', 'd', 'n', 'p', 'y', 'k'},
		{'s', 'v', 'n', 'y', 'h', 'r', 't', 'c', 'o', 'w', 'n', 'd', 'c', 'o', 'y', 's', 'k', 'x', 'q', 'j'},
		{'w', 'v', 'e', 'u', 'a', 'd', 'b', 'x', 's', 'j', 'o', 'u', 'y', 'f', 'x', 'j', 'k', 'b', 'd', 'g'},
		{'c', 'q', 's', 'y', 's', 'b', 'q', 'e', 'l', 'i', 'r', 's', 'z', 'e', 'w', 'p', 'm', 'c', 'z', 'z'},
		{'z', 'a', 'h', 'd', 'e', 'h', 'w', 'd', 'q', 'v', 'k', 'd', 'z', 'b', 'f', 'y', 'w', 'i', 'z', 'v'},
		{'o', 'o', 'q', 'g', 'l', 'g', 'k', 'h', 'h', 'l', 'a', 'y', 'w', 'n', 's', 'p', 'h', 'g', 's', 'w'},
		{'i', 'j', 'l', 'g', 'b', 'i', 'n', 'c', 'e', 'x', 'r', 'v', 'z', 'g', 'h', 'c', 'b', 'z', 'd', 'v'},
		{'e', 'e', 'k', 'q', 'v', 'y', 'n', 'k', 'a', 'r', 'u', 'k', 'i', 'v', 'n', 'j', 'z', 't', 'c', 'u'},
		{'y', 'z', 'k', 's', 'y', 'n', 'p', 't', 'p', 'l', 'u', 'q', 'i', 'd', 'a', 'h', 'z', 's', 'a', 's'},
		{'g', 'n', 'r', 'o', 'f', 'e', 'g', 'b', 'u', 'b', 'j', 'v', 'a', 't', 'k', 'g', 'z', 'l', 'w', 'm'},
		{'d', 'v', 'f', 'i', 'v', 'g', 'f', 'j', 's', 't', 'c', 'i', 'l', 'q', 's', 'f', 's', 'm', 'z', 'n'},
		{'q', 'c', 'u', 'e', 'z', 'l', 'n', 'i', 'n', 't', 'x', 'o', 'p', 'h', 's', 'n', 't', 'e', 'f', 'k'},
		{'u', 'e', 'u', 'r', 'u', 'f', 'n', 'y', 'r', 'y', 'a', 'i', 'v', 'm', 'l', 'p', 'n', 'c', 'g', 'e'},
	...
	char read1[20][20] = { {0} };
	char read2[20][20] = { {0} };
	read_puzzles(filename, read1, read2);
	for (int i = 0; i < 20; i++) {
		for (int j = 0; j < 10; j++) {
			if (read1[i][j] != expected1[i][j]) {
				return 1;
			}
			if (read2[i][j] != expected2[i][j]) {
				return 1;
			}
		}
	}
